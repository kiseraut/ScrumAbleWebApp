...
namespace ScrumAble.Migrations
{
    ...
    [Migration("20210612193444_UpdatedDBRelationships")]
    partial class UpdatedDBRelationships
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScrumAble.Models.ScrumAbleSprint", b =>
                {
                    b.HasOne("ScrumAble.Models.ScrumAbleRelease", "ReleaseId")
                        .WithMany("Sprints")
                        .HasForeignKey("ReleaseIdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ReleaseId");
                });
